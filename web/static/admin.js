  ...
  try {
    ...
    for (const a of apps) {
      ...
      html += `<tr>
        ...
        <td class="muted wrap" style="max-width:56rem">${esc(a.review_note || "—")}</td>
        <td class="muted">${fmtT(a.created_at)}</td>
        <td><div class="row-actions">
